import{u as d,j as e,M as h}from"./index-B0J67sDz.js";import"./react-vendor-v5ei6ytj.js";const u=`
  <p>
...
`,b=()=>{const{translationLanguage:s}=d(),l=s==="ur"||s==="urdu",o=s==="hi",p=s==="bn";let n=u,r="About Us",i="Available in multiple language",t="ltr",a="";return l?(n=g,r="ہمارے بارے میں",i="متعدد زبانوں میں دستیاب",t="rtl",a="font-urdu"):o?(n=c,r="हमारे बारे में",i="कई भाषाओं में उपलब्ध",t="ltr",a="font-hindi"):p&&(n=m,r="আমাদের সম্পর্কে",i="একাধিক ভাষায় উপলব্ধ",t="ltr",a="font-bengali"),e.jsx("div",{className:" mx-auto min-h-screen p-6 bg-white dark:bg-gray-900 font-poppins",children:e.jsxs("div",{className:"max-w-[1070px] w-full mx-auto",children:[e.jsxs("div",{className:"mb-8",children:[e.jsx("h1",{className:`text-3xl font-bold text-gray-900 mb-4 dark:text-white ${a}`,dir:t,children:r}),e.jsx("div",{className:" h-px bg-gray-200 "})]}),e.jsxs("div",{className:`dark:text-white text-gray-800 leading-relaxed ${a}`,dir:t,children:[e.jsx("div",{className:"prose prose-base dark:prose-invert prose-p:text-gray-700 dark:prose-p:text-gray-300 leading-7",dangerouslySetInnerHTML:{__html:n}}),e.jsxs("div",{className:`flex items-center mt-8 pt-4 ${l?"flex-row-reverse":""}`,children:[e.jsx("div",{className:"rounded-lg p-2 mr-3",style:{backgroundColor:"#2AA0BF"},children:e.jsx(h,{className:"w-6 h-6 text-white"})}),e.jsx("span",{className:"text-lg font-medium dark:text-white",style:{color:"#2AA0BF"},children:i})]})]})]})})};export{b as default};
