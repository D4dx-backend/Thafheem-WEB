import{i as f,j as e,M as b}from"./index-DmadXW_T.js";import"./react-vendor-v5ei6ytj.js";const y=`
  <p>
...
`,T=()=>{const{translationLanguage:r}=f(),t=r==="ur"||r==="urdu",g=r==="hi",c=r==="bn",h=r==="mal";let n=y,i="About Us",l="Available in multiple language",a="ltr",s="";return h?(n=N,i="About Us",l="ഒന്നിലധികം ഭാഷകളിൽ ലഭ്യമാണ്",a="ltr",s=""):t?(n=u,i="ہمارے بارے میں",l="متعدد زبانوں میں دستیاب",a="rtl",s="font-urdu"):g?(n=v,i="हमारे बारे में",l="कई भाषाओं में उपलब्ध",a="ltr",s="font-hindi"):c&&(n=A,i="আমাদের সম্পর্কে",l="একাধিক ভাষায় উপলব্ধ",a="ltr",s="font-bengali"),e.jsxs("div",{className:" mx-auto min-h-screen p-6 bg-white dark:bg-gray-900 font-poppins",children:[t&&e.jsx("style",{children:`
        ...
        `}),e.jsxs("div",{className:"max-w-[1070px] w-full mx-auto",children:[e.jsxs("div",{className:"mb-8",children:[e.jsx("h1",{className:`text-3xl font-bold text-gray-900 mb-4 dark:text-white ${s} ${t?"font-urdu-nastaliq":""}`,dir:a,style:t?{textAlign:"right",fontFamily:"'Noto Nastaliq Urdu', 'JameelNoori', serif"}:{},children:i}),e.jsx("div",{className:" h-px bg-gray-200 "})]}),e.jsxs("div",{className:`dark:text-white text-gray-800 leading-relaxed ${s}`,dir:a,children:[t?(()=>{const x=(()=>{let o=u.replace(/^<div[^>]*>/,"").replace(/<\/div>$/,"");const p=/<p[^>]*>[\s\S]*?<\/p>/g,d=[];let m;for(;(m=p.exec(o))!==null;)d.push(m[0]);return d})();return e.jsx("div",{dir:"rtl",className:"ml-4 sm:ml-6 md:ml-8 lg:ml-12",children:x.map((o,p)=>e.jsx("div",{className:"bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 mb-4 urdu-about-content",dir:"rtl",children:e.jsx("div",{dangerouslySetInnerHTML:{__html:o},style:{textAlign:"right",fontSize:"16px",lineHeight:"2.6",fontFamily:"'Noto Nastaliq Urdu', 'JameelNoori', serif"}})},p))})})():e.jsx("div",{className:"prose prose-base dark:prose-invert prose-p:text-gray-700 dark:prose-p:text-gray-300 leading-7",dangerouslySetInnerHTML:{__html:n}}),e.jsxs("div",{className:`flex items-center mt-8 pt-4 ${t?"flex-row-reverse":""}`,children:[e.jsx("div",{className:`rounded-lg p-2 ${t?"ml-3":"mr-3"}`,style:{backgroundColor:"#2AA0BF"},children:e.jsx(b,{className:"w-6 h-6 text-white"})}),e.jsx("span",{className:"text-lg font-medium dark:text-white",style:{color:"#2AA0BF"},children:l})]})]})]})]})};export{T as default};
