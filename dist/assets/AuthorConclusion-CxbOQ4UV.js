import{i as I,j as e,D as A,P as S}from"./index-D80Klju5.js";import{u as H,b as u}from"./react-vendor-v5ei6ytj.js";const C=`
<p class="eng">
...
`,O=()=>{const{translationLanguage:a}=I(),y=H(),p=a==="ur"||a==="urdu",h=a==="mal",f=a==="hi",c=a==="bn",g=a==="ta";if(u.useEffect(()=>{g&&y("/tamil/author-conclusion",{replace:!0})},[g,y]),g)return null;const[t,i]=u.useState(!1),l=u.useRef(null),k=()=>{l.current&&(t?l.current.pause():l.current.play(),i(!t))};let n=C,s="Author's Conclusion",r="ltr",m="prose prose-base dark:prose-invert prose-a:text-cyan-600 dark:prose-a:text-cyan-400 prose-p:text-gray-700 dark:prose-p:text-gray-300 leading-7 text-justify";return p?(n=v,s="مصنف کا اختتامیہ",r="rtl",m+=" font-urdu-nastaliq"):h?(n=w,s="രചയിതാവിന്റെ ഉപസംഹാരം",r="ltr",m+=" font-malayalam"):f?(n=N,s="लेखक का समापन",r="ltr"):c&&(n=T,s="লেখকের উপসংহার",r="ltr",m+=" font-bengali"),e.jsx("div",{className:"p-6 dark:bg-gray-900 min-h-screen",children:e.jsxs("div",{className:"sm:max-w-[1070px] max-w-[350px] w-full mx-auto font-poppins",children:[h?e.jsxs("div",{className:"flex items-center justify-between mb-4 border-b border-gray-300 dark:border-gray-600 pb-2",children:[e.jsx("h2",{className:"text-2xl font-bold dark:text-white font-malayalam",style:{fontFamily:"'NotoSansMalayalam'"},children:"രചയിതാവിന്റെ ഉപസംഹാരം"}),e.jsxs("div",{className:"relative group",children:[e.jsxs("button",{onClick:k,className:`relative flex items-center justify-center w-12 h-12 rounded-full transition-all duration-300 shadow-lg ${t?"bg-gradient-to-br from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 scale-105":"bg-gradient-to-br from-cyan-500 to-teal-600 hover:from-cyan-600 hover:to-teal-700 hover:scale-110"}`,style:{boxShadow:t?"0 4px 15px rgba(6, 182, 212, 0.4), 0 0 20px rgba(6, 182, 212, 0.2)":"0 4px 12px rgba(6, 182, 212, 0.3)"},children:[e.jsx("div",{className:"absolute inset-0 rounded-full bg-white opacity-0 hover:opacity-10 transition-opacity duration-300"}),t?e.jsx(A,{className:"w-5 h-5 text-white relative z-10",fill:"currentColor"}):e.jsx(S,{className:"w-5 h-5 text-white relative z-10 ml-0.5",fill:"currentColor"}),t&&e.jsx("span",{className:"absolute inset-0 rounded-full border-2 border-white border-opacity-30 animate-ping"})]}),e.jsxs("div",{className:"absolute right-0 top-full mt-2 px-3 py-1.5 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-50",children:[t?"Pause Audio":"Play Audio",e.jsx("div",{className:"absolute -top-1 right-4 w-2 h-2 bg-gray-900 dark:bg-gray-700 rotate-45"})]}),e.jsx("audio",{ref:l,src:"https://thafheem.net/audio/library/samapanam.ogg",onPlay:()=>i(!0),onPause:()=>i(!1),onEnded:()=>i(!1)})]})]}):e.jsx("h2",{className:`text-2xl font-bold mb-4 dark:text-white border-b border-gray-300 dark:border-gray-600 pb-2 ${p?"font-urdu":c?"font-bengali":""}`,dir:r,children:s}),p?e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
            ...
            `}),e.jsx("div",{className:"bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-5 sm:p-6 md:p-8",dir:"rtl",children:e.jsx("div",{className:"urdu-conclusion-content prose max-w-none prose-sm sm:prose-base dark:prose-invert text-gray-800 dark:text-gray-100 font-urdu-nastaliq",style:{fontFamily:"'Noto Nastaliq Urdu', 'JameelNoori', serif"},dangerouslySetInnerHTML:{__html:v.replace(/\n/g,"<br />")}})})]}):f?e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
            ...
            `}),e.jsx("div",{className:"bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 sm:p-8 md:p-10 lg:p-12",children:e.jsx("div",{className:"hindi-conclusion-content prose max-w-none prose-sm sm:prose-base dark:prose-invert text-gray-800 dark:text-gray-100",style:{fontFamily:"'Noto Sans Devanagari', 'Poppins', sans-serif"},dangerouslySetInnerHTML:{__html:N}})})]}):c?(()=>{const j=(()=>{let o=n.replace(/^<div[^>]*>/,"").replace(/<\/div>$/,"");const d=/(<p[^>]*>[\s\S]*?<\/p>)/g,b=[];let x;for(;(x=d.exec(o))!==null;)b.push(x[0]);return b})();return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
            ...
            `}),e.jsx("div",{className:"bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 sm:p-8 md:p-10 lg:p-12",children:e.jsx("div",{className:"malayalam-conclusion-content prose prose-base dark:prose-invert max-w-none leading-7 font-malayalam text-gray-800 dark:text-gray-100",style:{fontFamily:"'NotoSansMalayalam'"},dangerouslySetInnerHTML:{__html:w}})})]}):e.jsx("div",{className:m,dangerouslySetInnerHTML:{__html:n},dir:r})]})})};export{O as default};
