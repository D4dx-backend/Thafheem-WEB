...
${t}`),alert("Link copied to clipboard"))}catch(e){console.error("Share failed",e),alert("Share failed: "+e.message)}},[Xt,Ft]=h.useState(!1),[Zt,jt]=h.useState(1),te=()=>{const n=/^\d+/.exec(String(d))?.[0]||"1";jt(parseInt(n)),Ft(!0)},ht=n=>{if(!n||typeof n!="string")return n;const t=/\(?(\d+)\s*[:：]\s*(\d+)\)?/g;return n.replace(t,(e,r,i)=>e.includes("verse-reference-link")?e:`<span class="verse-reference-link inline-block cursor-pointer text-cyan-500 hover:text-cyan-600 dark:text-cyan-400 dark:hover:text-cyan-300 underline decoration-cyan-500/50 hover:decoration-cyan-600 dark:decoration-cyan-400/50 dark:hover:decoration-cyan-300 transition-colors" data-surah="${r}" data-ayah="${i}" title="Click to view Surah ${r}, Verse ${i}">${e}</span>`)},ee=n=>{if(n==null)return"";if(typeof n=="string")return ht(n);const t=["interpret_text","InterpretText","Interpret_Text","interpretation","Interpretation","text","Text","content","Content","meaning","Meaning","body","Body","desc","Desc","description","Description"];for(const e of t)if(typeof n[e]=="string"&&n[e].trim().length>0)return ht(n[e]);for(const[e,r]of Object.entries(n))if(typeof r=="string"&&r.trim().length>20)return ht(r);return console.warn("⚠️ No valid interpretation text found in item:",n),`<p class="text-gray-500 italic">No interpretation content available for interpretation ${m}</p>`},ne=document.getElementById("modal-root")||document.body;return ce.createPortal(N.jsxs(N.Fragment,{children:[N.jsx("style",{children:`
        ...
        `}),N.jsxs("div",{className:"fixed inset-0 z-[99999] flex items-end sm:items-center justify-center",children:[N.jsx("div",{className:"fixed inset-0 bg-gray-900/50 backdrop-blur-sm transition-opacity",onClick:ut,style:{pointerEvents:pt?"none":"auto"}}),N.jsxs("div",{className:`relative w-full ${c==="E"||c==="en"?"sm:w-auto sm:max-w-2xl":"sm:w-auto sm:max-w-4xl xl:max-w-[1073px]"} ${c==="E"||c==="en"?"sm:max-h-[95vh]":"max-h-[85vh] sm:max-h-[90vh]"} bg-white dark:bg-gray-900 rounded-t-2xl sm:rounded-2xl shadow-2xl flex flex-col animate-slideUp sm:animate-fadeIn ${c==="E"||c==="en"?"":"overflow-hidden"} ${pt?"animate-slideDown sm:animate-fadeOut":""}`,onClick:n=>n.stopPropagation(),style:{...c==="E"||c==="en"?{maxWidth:"42rem",minWidth:"min(90vw, 20rem)",height:"auto",maxHeight:"95vh"}:{}},children:[N.jsx("div",{className:"w-full flex justify-center pt-3 pb-1 sm:hidden cursor-grab active:cursor-grabbing",onClick:ut,style:{pointerEvents:pt?"none":"auto"},children:N.jsx("div",{className:"w-12 h-1.5 bg-gray-300 dark:bg-gray-600 rounded-full"})}),N.jsx("div",{className:"flex-shrink-0 z-10 bg-white dark:bg-gray-900",children:N.jsx(pe,{interpretationNumber:m,surahName:xt,verseRange:d.replace(/-/g," - "),language:c,onClose:ut,onBookmark:Gt,onShare:Qt,onWordByWord:te,bookmarking:Vt,surahOptions:Wt,rangeOptions:F,onPickSurah:qt,onPickRange:Jt,onPrev:(c==="E"||c==="en")&&$&&B.length>0?Kt?Bt:null:Bt,onNext:(c==="E"||c==="en")&&$&&B.length>0?Yt?Ct:null:Ct,isModal:!0,hideTitle:!!$},`navbar-${p}-${d}-${m}`)}),N.jsxs("div",{className:`${c==="E"||c==="en"?"overflow-y-auto":"flex-1 overflow-y-auto"} px-4 sm:px-6 py-6 sm:py-8 ${c==="E"||c==="en"?"":"min-h-0"}`,style:{...c==="E"||c==="en"?{maxHeight:"calc(95vh - 120px)"}:{}},children:[yt&&N.jsx("div",{className:"flex items-center justify-center py-8",children:N.jsxs("div",{className:"text-center",children:[N.jsx("div",{className:"animate-spin rounded-full h-12 w-12 border-b-2 border-cyan-500 mx-auto mb-4"}),N.jsx("p",{className:"text-gray-600 dark:text-gray-400",children:"Loading interpretation..."})]})}),st&&N.jsxs("div",{className:"text-center py-8",children:[N.jsx("p",{className:"text-red-500 dark:text-red-400 text-lg mb-2",children:"Failed to load interpretation"}),N.jsx("p",{className:"text-sm text-gray-600 dark:text-gray-400 mb-4",children:st}),N.jsx("button",{onClick:()=>window.location.reload(),className:"px-4 py-2 bg-cyan-500 text-white rounded-lg hover:bg-cyan-600 transition-colors",children:"Try Again"})]}),!yt&&!st&&H.length===0&&N.jsx("div",{className:"text-center py-10 text-gray-600 dark:text-gray-300",children:"No interpretation found for this selection."}),N.jsx("div",{className:"font-poppins space-y-6 sm:space-y-8",children:H.map((n,t)=>{const e=c==="ur"||c==="urdu";return N.jsx("div",{className:"mb-6 sm:mb-8",children:N.jsx("div",{className:`interpretation-content text-gray-700 leading-relaxed dark:text-gray-300 text-sm sm:text-base prose dark:prose-invert max-w-none text-justify ${e?"font-urdu-nastaliq urdu-interpretation-content":""}`,ref:r=>kt.current[t]=r,onClick:Lt,style:{pointerEvents:"auto",position:"relative",zIndex:1,...e?{textAlign:"right",fontSize:"16px",lineHeight:"2.6",fontFamily:"'Noto Nastaliq Urdu', 'JameelNoori', serif"}:{textAlign:"justify"}},dir:e?"rtl":"ltr",dangerouslySetInnerHTML:{__html:ee(n)}})},`${p}-${d}-${m}-${n?.ID||n?.id||t}`)})},`block-${p}-${d}-${m}`)]}),Xt&&N.jsx("div",{className:"fixed inset-0 bg-black/50 backdrop-blur-sm flex items-start justify-center z-[100000] pt-24 sm:pt-28 lg:pt-32 p-4 overflow-hidden",children:N.jsx(le,{selectedVerse:Zt,surahId:p,onClose:()=>Ft(!1),onNavigate:jt,onSurahChange:()=>{}})})]})]}),N.jsx(oe,{isOpen:ct,onClose:()=>Nt(!1),noteId:bt.id,noteContent:bt.content}),lt&&X.surahId&&X.verseId&&N.jsx(de,{surahId:X.surahId,verseId:X.verseId,onClose:()=>T(!1),interpretationNo:m,language:c})]}),ne)};export{xe as B};
