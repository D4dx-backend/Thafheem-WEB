import{j as e,aD as h,aE as g}from"./index-D0NMIq43.js";import{b as l}from"./react-vendor-v5ei6ytj.js";const y=()=>{const[p,m]=l.useState([]),[i,x]=l.useState(!0),[d,c]=l.useState(null),[a,s]=l.useState({open:!1,footnoteId:"",content:"",loading:!1,error:null});l.useEffect(()=>{let t=!0;return(async()=>{try{x(!0),c(null);const r=await h();if(!t)return;m(r.sections||[]),r.error&&c("Unable to fetch content from the server.")}catch{t&&(c("Unable to load content. Please try again later."),m([]))}finally{t&&x(!1)}})(),()=>{t=!1}},[]);const f=async t=>{const n=t.target.closest(".footnote-link")||t.target.closest("sup.footnote-link");if(!n)return;const r=n.getAttribute("data-footnote-id");if(!r){console.log("No footnote ID found on target:",n);return}t.preventDefault(),t.stopPropagation(),console.log("Footnote clicked:",r),s({open:!0,footnoteId:r,content:"Loading...",loading:!0,error:null});try{const o=await g(r);if(o?.footnote_text)s({open:!0,footnoteId:r,content:o.footnote_text,loading:!1,error:null});else throw o?.error?new Error(o.error):new Error("Footnote content not available")}catch(o){s({open:!0,footnoteId:r,content:"Footnote content not available.",loading:!1,error:o?.message||"Unable to load footnote."})}},w=(t=0)=>{let n="max-w-lg";t<=300?n="max-w-md":t<=600?n="max-w-lg":t<=1200?n="max-w-2xl":t<=2e3?n="max-w-3xl":n="max-w-4xl";const r=t>1500;return{widthClass:n,needsMaxHeight:r}};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        .prose-content img {
