import{u as p,A as b,j as e}from"./index-B0J67sDz.js";import{d as y,u as h,b as r}from"./react-vendor-v5ei6ytj.js";const j=()=>{const{id:n}=y(),u=h(),[d,l]=r.useState(!0),[o,m]=r.useState(null),[t,f]=r.useState(null),[x,c]=r.useState(!1),{translationLanguage:a}=p();r.useEffect(()=>{let s=!0;return(async()=>{try{l(!0),m(null);const i=await b(n);if(!s)return;f(i),setTimeout(()=>c(!0),50)}catch(i){if(!s)return;m(i.message||"Failed to load note"),setTimeout(()=>c(!0),50)}finally{s&&l(!1)}})(),()=>{s=!1}},[n]);const g=()=>typeof t=="string"?t:t&&typeof t=="object"?t.NoteText||t.html||t.content||t.text||JSON.stringify(t):"<p>No content</p>";return e.jsxs("div",{className:"min-h-screen bg-white dark:bg-[#2A2C38]",children:[e.jsx("style",{children:`
          @keyframes slideInUp {
            from {
              opacity: 0;
