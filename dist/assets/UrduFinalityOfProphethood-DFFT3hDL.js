import{j as t,aq as w,ar as N}from"./index-D0NMIq43.js";import{b as p}from"./react-vendor-v5ei6ytj.js";const q=()=>{const[u,b]=p.useState([]),[f,y]=p.useState(!0),[c,h]=p.useState(null),[i,d]=p.useState({open:!1,footnoteId:"",content:"",loading:!1,error:null});p.useEffect(()=>{let o=!0;return(async()=>{try{y(!0),h(null);const e=await w();if(!o)return;b(e.sections||[]),e.error&&h("Unable to fetch content from the server.")}catch{o&&(h("Unable to load content. Please try again later."),b([]))}finally{o&&y(!1)}})(),()=>{o=!1}},[]);const k=async o=>{const r=o.target.closest(".footnote-link")||o.target.closest("sup.footnote-link");if(!r)return;const e=r.getAttribute("data-footnote-id");if(!e){console.log("No footnote ID found on target:",r);return}o.preventDefault(),o.stopPropagation(),console.log("Footnote clicked:",e),d({open:!0,footnoteId:e,content:"Loading...",loading:!0,error:null});try{const n=await N(e);if(n?.footnote_text)d({open:!0,footnoteId:e,content:n.footnote_text,loading:!1,error:null});else throw n?.error?new Error(n.error):new Error("Footnote content not available")}catch(n){d({open:!0,footnoteId:e,content:"Footnote content not available.",loading:!1,error:n?.message||"Unable to load footnote."})}},v=(o=0)=>{let r="max-w-3xl",e="min(85vw, 500px)",n="min(90vw, 800px)";o<=300?(r="max-w-xl",e="min(80vw, 450px)",n="min(85vw, 576px)"):o<=800?(r="max-w-2xl",e="min(85vw, 500px)",n="min(90vw, 672px)"):o<=1500?(r="max-w-3xl",e="min(85vw, 550px)",n="min(90vw, 768px)"):(r="max-w-4xl",e="min(88vw, 600px)",n="min(92vw, 896px)");const g=o>500;return{widthClass:r,needsMaxHeight:g,minWidth:e,maxWidth:n}};return t.jsxs(t.Fragment,{children:[t.jsx("style",{children:`
