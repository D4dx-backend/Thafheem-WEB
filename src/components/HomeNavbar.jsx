...
const HomepageNavbar = () => {
  ...
  return (
    <>
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-40">
          <div className="absolute left-0 top-0 h-full w-80 bg-white dark:bg-[#2A2C38] shadow-lg overflow-y-auto">
                ...
                return (
                  <div key={index}>
                    <button
                      ...
                      className="w-full flex items-center justify-between px-6 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-black transition-colors text-left"
                    >
                      <div className="flex items-center space-x-3">
                    ...
                    {item.hasSubmenu && openSubmenu === index && (
                      <div className="bg-gray-50 dark:bg-[#2A2C38]  ml-6">
                        {item.submenuItems.map((subItem, subIndex) => (
                          <button
                            key={subIndex}
                            onClick={() => {
                            ...
                            className="w-full flex items-center px-6 py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-black transition-colors text-left text-sm"
                          >
                            <span className="mr-3">•</span>
                            <span>{subItem.label}</span>
                          </button>
