...
//             {/* Hide settings on small screens to save space */}
//             <button
...
//                         }
//                       }}
//                       className="w-full flex items-center justify-between px-4 sm:px-6 py-3 sm:py-3 text-gray-700 dark:text-gray-300 hover:bg-[#ebeef0] dark:hover:bg-black transition-colors text-left min-h-[48px]"
//                     >
//                       <div className="flex items-center space-x-3">
//                         <IconComponent size={18} className="text-gray-500 dark:text-gray-400 flex-shrink-0" />
//                         <span className="text-sm sm:text-sm leading-tight">{item.label}</span>
//                       </div>
//                       {item.hasArrow && (
//                         <ChevronRight
//                           size={16}
//                           className={`text-gray-400 transition-transform flex-shrink-0 ${openSubmenu === index ? "rotate-90" : ""}`}
//                         />
//                       )}
//                     </button>
...
//                               setIsMenuOpen(false);
//                             }}
//                             className="w-full flex items-center px-4 sm:px-6 py-2 sm:py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-black transition-colors text-left text-sm min-h-[44px]"
//                           >
...
//                       setIsMenuOpen(false);
//                     }}
//                     className="w-full flex items-center space-x-3 px-4 sm:px-6 py-3 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 transition-colors text-left min-h-[48px]"
//                   >
