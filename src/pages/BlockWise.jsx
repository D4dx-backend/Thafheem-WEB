      ...
      <div className="w-full mx-auto min-h-screen bg-white dark:bg-black">
        <div className="max-w-6xl mx-auto px-3 sm:px-6">
          ...
          <div className="bg-white dark:bg-black py-4 sm:py-6">
            ...
            {/* Bottom Section */}
            {/* <div className="flex flex-col sm:flex-row items-center justify-between w-full space-y-3 sm:space-y-0 px-4 sm:px-0">
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-gray-900 dark:bg-white rounded-full"></div>
                <Link to="/surahinfo">
                  <span className="text-sm text-gray-600 dark:text-white cursor-pointer hover:underline">
          ...
          <div className="max-w-5xl mx-auto pb-6 sm:pb-8">
            ...
            <div className="mb-4 sm:mb-6 p-4 sm:p-6 lg:p-8 bg-gray-50 dark:bg-black rounded-lg">
              ...
              >
                ...
                مَّشَوْا۟ فِيهِ وَإِذَآ أَظْلَمَ عَلَيْهِمْ قَامُوا۟ ۚ وَلَوْ
                شَآءَ ٱللَّهُ لَذَهَبَ بِسَمْعِهِمْ وَأَبْصَٰرِهِمْ ۚ إِنَّ
                ٱللَّهُ عَلَىٰ كُلِّ شَىْءٍ قَدِيرٌ ﴿٢٠﴾
              </p>
            </div>
