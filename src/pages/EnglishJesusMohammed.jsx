...
import { fetchEnglishJesusMohammed } from "../api/apifunction";

const EnglishJesusMohammed = () => {
  ...
  useEffect(() => {
    ...
    const loadContent = async () => {
      try {
        setLoading(true);
        setError(null);
        const data = await fetchEnglishJesusMohammed();
        if (!isMounted) {
          return;
        }
...
export default EnglishJesusMohammed;
