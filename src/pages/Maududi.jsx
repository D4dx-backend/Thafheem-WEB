        ...
        <div className="max-w-4xl mx-auto bg-white p-8">
            ...
            <div className="flex gap-6 mb-8">
                ...
                <div className="flex-1">
                    <h3 className="text-blue-600 font-normal mb-3 text-sm">(1903-1979)</h3>
            ...
            <div className="mb-6">
                <h2 className="text-blue-600 font-normal mb-4 text-base">
            ...
            <div className="mb-6">
                ...
                <div className="flex gap-4 mb-3">
                    ...
                    <div className="flex-1">
                        <p className="text-black leading-normal text-sm">
                ...
                <div className="bg-gray-200 rounded-lg overflow-hidden shadow-sm">
                    ...
                    <div className="bg-gray-100 px-4 py-3">
                        <div className="flex items-center justify-between">
                            <div className="text-sm text-gray-700 font-mono min-w-[45px]">
