        ...
        return (
            <div className="mx-auto bg-white dark:bg-gray-900 p-2 sm:p-4 md:p-6 lg:p-8 font-poppins">
                <div className="max-w-[959.01px] mx-auto px-2 sm:px-4 lg:px-0 lg:ml-50">
                    ...
                    <div
                        className="prose max-w-none prose-sm sm:prose-base dark:prose-invert text-gray-800 dark:text-gray-100 font-bengali leading-7"
                        dangerouslySetInnerHTML={{ __html: BANGLA_CONTENT }}
                    />
                </div>
            </div>
        );
