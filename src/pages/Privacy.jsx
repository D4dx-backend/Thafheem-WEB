...
//         <div className="w-[1070.01px] mx-auto px-4 py-4">
...
// </div>
//         </div>
//         <div className="w-[1070.01px] mx-auto   px-6">
...
//               <p className="text-base text-black leading-relaxed mb-4 dark:text-white">
...
//               </h3>
//               <p className="text-base text-black leading-relaxed mb-3 dark:text-white">
//                 We may collect and process the following information about you:
//               </p>

//               <ul className="list-disc pl-6 space-y-2 text-base text-black dark:text-white">
//                 <li>
...
//               </h3>
//               <p className="text-base text-black leading-relaxed dark:text-white">
...
//               <p className="text-base text-black mt-4  dark:text-white">
...
//             <div className="text-base text-black mt-8 dark:text-white">
...
//   </p>
//   <p className="text-[#2AA0BF]">
//     Website: <a href="https://d4media.in/" target="_blank" rel="noopener noreferrer" className="text-[#2AA0BF] hover:underline dark:text-[#4FAEC7]">https://d4media.in/</a>
//   </p>
