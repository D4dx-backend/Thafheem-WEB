...
const Quiz = () => {
  ...
  return (
    <div className="min-h-screen dark:bg-black bg-gray-100">
      {/* Top Navigation Bar */}
      <div className="bg-[#2A2C38] border-b border-gray-700">
      <div className="max-w-7xl mx-auto px-4 py-2">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            {/* Surah Dropdown */}
            <div
              className="flex items-center gap-2 cursor-pointer px-3 py-1 rounded hover:bg-[#3A3C48]"
              onClick={toggleSurahDropdown}
            >
              <span className="text-white font-medium">Al-Fatihah</span>
            ...
            {/* Verse Range */}
            <span className="text-sm text-gray-300">1 - 7</span>
          </div>
