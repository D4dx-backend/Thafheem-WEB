      ...
      <div className="min-h-screen bg-gray-50 dark:bg-black">
        ...
        <div className="bg-white px-4 py-8 dark:bg-black">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* Surah Title */}
            <div className="mb-6">
              <h1 className="text-5xl font-arabic text-gray-900 dark:text-white mb-4">البقرة</h1>
        ...
        <div className="max-w-4xl mx-auto px-4 py-6">
          ...
          <div className="bg-white dark:bg-black rounded-lg p-6 mb-6">
            <div className="text-right">
              <p className="text-2xl font-arabic leading-loose dark:text-white text-gray-900 mb-4">
