    ...
    <div className="min-h-screen bg-white dark:bg-black flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full max-w-sm sm:max-w-md lg:max-w-lg">
          ...
          <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm dark:text-white text-black">
            <div className="flex items-center justify-between space-x-1 sm:space-x-2">
              <div className="flex items-center space-x-1 sm:space-x-2">
                ...
                <span className="text-black dark:text-white font-poppins sm:text-[14px]">New! Notes & Reflections</span>
              </div>
              <div className="flex items-center space-x-1 sm:space-x-2">
                <Sun className="w-3 h-3 sm:w-4 sm:h-4 text-black dark:text-white flex-shrink-0" />
                <span className="text-black dark:text-white font-poppins sm:text-[14px]">Create collections</span>
              </div>
            </div>
            <div className="flex items-center justify-between space-x-1 sm:space-x-2 text-black">
              <div className="flex items-center space-x-1 sm:space-x-2">
                <Sun className="w-3 h-3 sm:w-4 sm:h-4 text-black dark:text-white flex-shrink-0" />
                <span className="dark:text-white font-poppins sm:text-[14px]">Sync your data across browsers</span>
              </div>
              <div className="flex items-center space-x-1 sm:space-x-2">
                <Sun className="w-3 h-3 sm:w-4 sm:h-4 text-black dark:text-white flex-shrink-0" />
                <span className="dark:text-white font-poppins sm:text-[14px]">Create collections</span>
              </div>
            </div>
            <div className="flex items-center justify-between space-x-1 sm:space-x-2">
              <div className="flex items-center space-x-1 sm:space-x-2">
        ...
        <div className="text-center mb-6">
          <p className="text-black dark:text-white text-xs sm:text-sm mb-4 font-poppins sm:text-[14px]">Sign in or Sign up now:</p>
          ...
          <div className="space-y-3">
            <button className="w-full max-w-[410px] mx-auto flex items-center justify-center space-x-3 px-4 py-3 bg-[#EEEEEE] dark:hover:bg-[#373737] dark:bg-[#373737] rounded-lg transition-colors">
              ...
              <span className="text-black font-medium dark:text-white text-sm sm:text-base font-poppins">Continue with Google</span>
            </button>
            ...
            <button className="w-full max-w-[410px] mx-auto flex items-center justify-center space-x-3 px-4 py-3 bg-[#EEEEEE] dark:hover:bg-[#373737] dark:bg-[#373737] text-black rounded-lg transition-colors">
              ...
              <span className="font-medium text-black dark:text-white text-sm sm:text-base font-poppins">Continue with Apple</span>
            </button>
          </div>
        </div>
