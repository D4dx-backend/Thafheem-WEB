  ...
  useEffect(() => {
    ...
    const loadContent = async () => {
      try {
        setLoading(true);
        setError(null);
        const data = await fetchTamilFinalityOfProphethood();
        if (!isMounted) {
          return;
        }
            ...
            <div className="space-y-8">
              {sections.map((section, index) => (
                ...
                >
                  ...
                  <div
                    className="prose prose-sm sm:prose-base dark:prose-invert max-w-none leading-relaxed text-gray-800 dark:text-gray-200 break-words overflow-wrap-anywhere tamil-finality-content"
...
export default TamilFinalityOfProphethood;
