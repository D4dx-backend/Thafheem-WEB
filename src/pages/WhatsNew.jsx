  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg font-semibold text-gray-700 mb-1">Version 4.0.48</p>
        <p className="text-gray-500">Discover our latest updates and improvements</p>
      </div>
      ...
      <div className="mb-8">
        <div className="flex items-center mb-6">
          ...
          <h2 className="text-xl font-semibold text-[#2AA0BF]">New Features & UI:</h2>
        </div>
        
        <div className="space-y-3">
          {newFeatures.map((feature, index) => (
            <div key={index} className="flex items-start">
              <CheckCircle className="w-5 h-5 text-[#2AA0BF] mt-0.5 mr-3 flex-shrink-0" />
